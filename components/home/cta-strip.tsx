...
export default function CtaStrip() {
  ...
  return (
    ...
    >
      ...
      >
        GLOBAL GROWTH<span className="text-primary"> · </span>
        CREATOR POWER<span className="text-primary"> · </span>
        MEDIA AT SCALE<span className="text-primary"> · </span>
      </motion.div>
      ...
      <div className="mx-auto max-w-[1600px] px-6 md:px-10 mt-16 grid grid-cols-1 md:grid-cols-12 gap-8 items-end">
        ...
        <div className="md:col-span-5 flex flex-wrap gap-3 md:justify-end">
          <Link
            href="/contact"
            className="group inline-flex items-center gap-2 bg-sunset-gradient px-6 py-4 font-semibold text-black"
          >
            Start a Project
